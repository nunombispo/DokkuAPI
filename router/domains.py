...
def get_router(app):
    ...
    async def letsencrypt_set_mail(request: Request, mail: str):
    ...
    async def letsencrypt_enable_app(request: Request, app_name: str):
    ...
    async def letsencrypt_enable_auto_renewal(request: Request):
