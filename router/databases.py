...
def get_router(app):
    ...
    async def list_databases(request: Request, plugin_name: str):
    ...
    @router.post("/databases/links/{plugin_name}/{database_name}/{app_name}", response_description="Link a database to an app")
    ...
    @router.delete("/databases/links/{plugin_name}/{database_name}/{app_name}", response_description="Unlink a database from an app")
